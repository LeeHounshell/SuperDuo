...
// from: https://github.com/dm77/barcodescanner/blob/master/zbar/sample/src/main/java/me/dm7/barcodescanner/zbar/sample/ZBarScannerActivity.java
public class ZBarScannerActivity extends AppCompatActivity
    implements
...
{
    private final static String TAG = "LEE: <" + ZBarScannerActivity.class.getSimpleName() + ">";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // FIXED: Prefer "'SHOW_AS_ACTION_IF_ROOM'" instead of "'SHOW_AS_ACTION_ALWAYS'"
    ...
    public void handleResult(Result rawResult) {
        ...
        returnIntent.putExtra("content", rawResult.getContents());
        returnIntent.putExtra("format", rawResult.getBarcodeFormat().getName());
